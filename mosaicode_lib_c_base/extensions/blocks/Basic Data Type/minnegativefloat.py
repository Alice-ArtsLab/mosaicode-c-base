...
# -*- coding: utf-8 -*-
"""
This module contains the MinNegativeFloat class.
"""
from mosaicode.GUI.fieldtypes import *
from mosaicode.model.blockmodel import BlockModel


class MinNegativeFloat(BlockModel):
    # -------------------------------------------------------------------------
    ...
    def __init__(self):
        ...
        self.language = "c"
        self.extension = "base"
        self.help = "Min negative float value."
        self.label = "MinNegativeFloat"
